...
cask "atom"                              # Github Atom - Text editor
...
brew "espeak"                            # Text to speech, software speech synthesizer
...
brew "ankitpokhrel/jira-cli/jira-cli"    # Feature-rich interactive Jira command-line
...
brew "robscott/tap/kube-capacity"        # kube-capacity provides an overview of the resource requests, limits, and utilization in a Kubernetes cluster
...
brew "johanhaleby/kubetail/kubetail"     # Tail logs from multiple Kubernetes pods at the same time
brew "kustomize"                         # Template-free customization of Kubernetes YAML manifests
cask "lens"                              # Kubernetes IDE
brew "liquibase"                         # Library for database change tracking
...
cask "microsoft-azure-storage-explorer"  # Explorer for Azure Storage
cask "mongodb-compass"                   # Interactive tool for analyzing MongoDB data
cask "mono-mdk-for-visual-studio"        # Open source implementation of Microsoft's .NET Framework
brew "nmap"                              # Port scanning utility for large networks
brew "node-build"                        # Install NodeJS versions
brew "nodenv"                            # Manage multiple NodeJS versions
brew "p11-kit"                           # Library to load and enumerate PKCS#11 modules
...
brew "powershell/tap/powershell"         # Formula to install PowerShell
...
brew "warrensbox/tap/tfswitch"           # The tfswitch command lets you switch between terraform versions.
...
cask "wireshark"                         # Network analyzer and capture tool
